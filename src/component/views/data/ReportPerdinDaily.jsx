        ...
        Swal.fire({
            ...
            willOpen: () => {
                setTimeout(async () => {
                    setLoading(false);
                    try {
                        await fetch('http://localhost:4001/user/report-perdin-daily', {
                            method: "GET",
                            headers: {
                            ...
                            .then(blob => {
                                ...
                                link.href = url
                                link.setAttribute('download', 'perdin_daily_report.xlsx')
...
export default ReportPerdinDaily